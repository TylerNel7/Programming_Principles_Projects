...
#Display welcome message ValueError
...
while True:
    ...
    if choice == 'a':
        ...
        #Obtain setup and punchline variables with input_somthing function, create a dictionary, append to list and save, followed by a confirmation message
        ...
        #If data_list is empty, display message "no jokes saved". Otherwise, list through all jokes and display the setup for each
        if data_list == []:
        ...
        #If data_list is empty, display message "no jokes saved". Otherwise, prompt for user input with input_something fucntion, display message and search for term in all 
        #jokes and display all jokes that return true
        if data_list == []:
            print('No jokes saved')
        else:
        ...
        # See Point 6 of the "Requirements of admin.py" section of the assignment brief.
         ...
         #If data_list is empty, display message "no jokes saved". Otherwise, prompt user for integer with input_int function and try to display joke. If 'laughs' and 'groans'
         #are both 0, display message. otherwise show the value for each. Except is value is a IndexError, then display message
        if data_list == []:
            print('No jokes saved')
        else:
        ...
        # See Point 7 of the "Requirements of admin.py" section of the assignment brief.
         ...
         #If data_list is empty, display message "no jokes saved". Otherwise, prompt user for integer with input_int function and try to delete corresponding joke, then display 
         #confirmation message. Except if indexError is true, then display error message
        if data_list == []:
            print('No jokes saved')
        else:
